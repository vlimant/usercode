...
pair<bool,reco::Track> MuonTrackLoader::buildTrackAtPCA(const Trajectory& trajectory) const {
  ...
  if(extrapolationResult.first)
	...
	math::XYZPoint zeroP(0,0,0);
	math::XYZVector zeroV(0,0,0);
	reco::TrackBase::CovarianceMatrix mat;
        return pair<bool,reco::Track>(true,reco::Track(0,0,zeroP,zeroV,0,mat));
      }
    }
  }
