					...
					PropagationDirection dir) const
{
  ...
  LogDebug("TkNavigation") <<"barrel nextLayers decided to go: "<<((dirOppositeXORisInOutTrack)?"outer":"inner")<<"\n"
			       <<"on "<<((signZmomentumXORdir)?"Negative":"Positive")<<" layers\n"
			       <<"for a direction: "<<dir<<"\n"
			       <<"and isInOutTrack: "<<isInOutTrack<<"\n"
			       <<"at:\n"<<fts;
