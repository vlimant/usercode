            ...
            tracks = cms.PSet(
            	...
            	Class = cms.string('reco::CaloCluster')
	          	...
	          	Class = cms.string('reco::CaloCluster')   
						...
						convTk = cms.PSet(
              src = cms.InputTag("trackerOnlyConversions",""),
              leaves = cms.PSet(
            	vars = cms.vstring(
								#'theTrackPin_x:tracksPin.size',
								'tracksPin_x1:tracksPin.at(0).X',
								'tracksPin_x2:tracksPin.at(1).Y',
								'tracksPin_y1:tracksPin.at(0).Y',
								'tracksPin_y2:tracksPin.at(1).Y',
								'tracksPin_z1:tracksPin.at(0).Z',
								'tracksPin_z2:tracksPin.at(1).Z',
								'tracksPout_x1:tracksPout.at(0).X',
								'tracksPout_x2:tracksPout.at(1).Y',
								'tracksPout_y1:tracksPout.at(0).Y',
								'tracksPout_y2:tracksPout.at(1).Y',
								'tracksPout_z1:tracksPout.at(0).Z',
								'tracksPout_z2:tracksPout.at(1).Z',
								'ecalImpactPosition_x1:ecalImpactPosition.at(0).X',
								'ecalImpactPosition_x2:ecalImpactPosition.at(1).Y',
								'ecalImpactPosition_y1:ecalImpactPosition.at(0).Y',
								'ecalImpactPosition_y2:ecalImpactPosition.at(1).Y',
								'ecalImpactPosition_z1:ecalImpactPosition.at(0).Z',
								'ecalImpactPosition_z2:ecalImpactPosition.at(1).Z',
								'tracksInnerPosition_x1:tracksInnerPosition.at(0).X',
								'tracksInnerPosition_x2:tracksInnerPosition.at(1).Y',
								'tracksInnerPosition_y1:tracksInnerPosition.at(0).Y',
								'tracksInnerPosition_y2:tracksInnerPosition.at(1).Y',
								'tracksInnerPosition_z1:tracksInnerPosition.at(0).Z',
								'tracksInnerPosition_z2:tracksInnerPosition.at(1).Z',
								'tracks_px1:tracks.at(0).px',
								'tracks_py1:tracks.at(0).py',
								'tracks_pz1:tracks.at(0).pz',
								'tracks_phi1:tracks.at(0).phi',
								'tracks_d01:tracks.at(0).d0',
								'tracks_dz1:tracks.at(0).dz',
								'tracks_charge1:tracks.at(0).charge',
								'tracks_px2:tracks.at(1).px',
								'tracks_py2:tracks.at(1).py',
								'tracks_pz2:tracks.at(1).pz',
								'tracks_phi2:tracks.at(1).phi',
								'tracks_d02:tracks.at(1).d0',
								'tracks_dz2:tracks.at(1).dz',
								'tracks_charge2:tracks.at(1).charge',
								'bcMatchingWithTracks_x1:bcMatchingWithTracks.at(0).x',
								'bcMatchingWithTracks_y1:bcMatchingWithTracks.at(0).y',
								'bcMatchingWithTracks_z1:bcMatchingWithTracks.at(0).z',
								'bcMatchingWithTracks_x2:bcMatchingWithTracks.at(1).x',
								'bcMatchingWithTracks_y2:bcMatchingWithTracks.at(1).y',
								'bcMatchingWithTracks_z2:bcMatchingWithTracks.at(1).z',
								'bcMatchingWithTracks_energy1:bcMatchingWithTracks.at(0).energy',
								'bcMatchingWithTracks_energy2:bcMatchingWithTracks.at(1).energy',
								'EoverP:EoverP'								
							)
            ),
...
#                        'class:classification', 
                        ...
                        'tk_isEcalDriven:gsfTrack.isEcalDriven',
